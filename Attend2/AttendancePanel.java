...
public class AttendancePanel extends JPanel {
    ...
    public AttendancePanel(JFrame owner, String lectureName, AttendanceManager attManager) {
    ...
    private void 처리하기(Window window, AttendanceManager manager, String lectureName, String 상태) {
        String 오늘 = LocalDate.now().toString();
        manager.addRecord(new AttendanceRecord(lectureName, 오늘, 상태));

        JOptionPane.showMessageDialog(window, 상태 + " 처리 완료!");
